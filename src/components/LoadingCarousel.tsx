...
export function LoadingCarousel({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "w-full max-w-5xl mx-auto rounded-xl bg-muted shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05),0px_1px_1px_0px_rgba(255,252,240,0.5)_inset,0px_0px_0px_1px_hsla(0,0%,100%,0.1)_inset,0px_0px_1px_0px_rgba(28,27,26,0.5)]",
        className
      )}
    >
      <div className="w-full overflow-hidden rounded-xl">
                    ...
                    {backgroundTips ? (
                      ...
                      >
                        {displayTips[current]?.url ? (
                          ...
                          >
                            <p className="text-white text-center md:text-left text-sm sm:text-base md:text-lg tracking-tight font-normal leading-snug">
                              {tip.text}
                            </p>
                          </a>
                        ) : (
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start space-x-0 sm:space-x-2 text-primary whitespace-normal">
              {backgroundTips ? (
                ...
                <div className="flex flex-col">
                  {displayTips[current]?.url ? (
                    ...
                    <span className="text-sm md:text-base lg:text-lg font-normal tracking-tight">
                      {animateText ? (
                        <TextScramble
                          key={displayTips[current]?.text}
                          duration={1.2}
