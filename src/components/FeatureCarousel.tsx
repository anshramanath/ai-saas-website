...
const steps = [
  {
    id: "1",
    name: "Step 1",
    title: "Content Ideas in Seconds",
    description: "Generate engaging post ideas instantly using real-time trends and AI-powered prompts.",
  },
  {
    id: "2",
    name: "Step 2",
    title: "Automated UGC Scripts",
    description: "Write short-form video scripts optimized for virality with zero creative block.",
  },
  {
    id: "3",
    name: "Step 3",
    title: "Multi-Platform Ready",
    description: "Export ready-to-use content formats tailored for TikTok, IG, YouTube & more.",
  },
  {
    id: "4",
    name: "Step 4",
    title: "Client Collaboration, Simplified",
    description: "Share workflows and get approvals fast with branded exports and smart commenting.",
  },
] as const
...
const StepImage = forwardRef<
  HTMLImageElement,
  StepImageProps & Omit<React.ComponentProps<typeof Image>, "src" | "alt">
>(
  (
      ...
      >
        <div className="m-10 min-h-[450px] w-full">
          <AnimatePresence mode="wait">
            <motion.div
              key={step}
              className="flex w-4/6 flex-col gap-3 pt-10"
    ...
    const content = () => {
      switch (step) {
        case 0:
          ...
          return (
            <motion.div
              className="relative w-full h-full -mt-26 md:-mt-0"
        ...
        case 1:
          ...
          return (
            <motion.div
              className="relative w-full h-full -mt-37 md:-mt-0"
              onAnimationComplete={handleAnimationComplete}
            >
              <AnimatedStepImage
                alt={image.alt}
        ...
        case 3:
          ...
          return (
            <motion.div
              className={clsx(
                "absolute left-1/2 top-1/4 -translate-x-1/2 -translate-y-1/4 flex w-full flex-col gap-12 text-center text-2xl font-bold md:w-[60%]"
              )}
  ...
  return (
    <FeatureCard {...props} step={step}>
      ...
      <motion.div
        ...
        className="absolute left-[12rem] top-5 z-50 h-full w-full cursor-pointer hidden md:block"
      >
